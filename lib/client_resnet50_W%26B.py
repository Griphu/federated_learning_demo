...
wandb.init(project="FL_test")
wandb.run.name="abdul"
# #############################################################################
...
def load_data():
    ...
    train_data = ImageFolder("/media/magda/DYSKWIN/dyskD/federated/bazy/abdul_four_classes/train", transform=train_transform)
    test_data = ImageFolder("/media/magda/DYSKWIN/dyskD/federated/bazy/abdul_four_classes/test", transform=test_transform)

    return DataLoader(train_data, batch_size=4, shuffle=True), DataLoader(test_data)
