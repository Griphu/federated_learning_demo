...
parser.add_argument('-pn','--project_name',default='FL_paper_local_4_classes', required=True)
parser.add_argument('-rn','--run_name', default='DDSM', required=True)
parser.add_argument('-d','--data_path', default = 'data/baza_student_raw/ddsm_four_classes_split', required=True)
